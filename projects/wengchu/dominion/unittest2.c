...
int main()
{
    ...
    minionR(choice1, choice2, currentPlayer, &stateT, handPos, &bonus);

    //assert the results
     //test +1 action
    printf("actions = %d, expected = %d\n", stateT.numActions, testAction + 1); //test introduce bug 1
    assertM("+1 action", stateT.numActions == testAction + 1);
    printf("------------------ \n");
     //test +2 coins
    printf("coins= %d, expected = %d\n", stateT.coins, testCoin + 2); //test introduce bug 2
