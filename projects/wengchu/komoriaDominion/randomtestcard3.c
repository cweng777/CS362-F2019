...
#define TEST_FUNCTION "handleTribute"
...
int main()
{
    ...
    for (x = 0; x <= 200 ; x++)
    {
        ...
        //call the refactored functions
         handleTribute(currentPlayer, nextPlayer, &state, 0);
          ...
          )
        {
            ...
            printf("actions = %d, expected = %d\n", state.numActions, stateT.numActions); 
